  ...
  <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
    ...
    <ul class="space-y-4">
      <li 
        ...
        :key="product.id" 
        :data-id="product.id" 
        class="p-4 border border-gray-200 rounded-lg shadow-sm product-item"
      >
        ...
        <button @click="editProduct(product)" class="w-50 bg-purple-700 text-white p-1 mr-3 rounded-lg font-semibold hover:bg-purple-800 transition-colors" >Editar</button>
